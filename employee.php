        ...
        <li class="mb-1">
          ...
          <div class="collapse drop-down-menu show" id="home-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 ">
              <li><a href="employee.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded my-1" style="margin-left: 40px;"><i class="fa-solid fa-users" style="color:#0d6efd; margin-top: 8px;" ></i><span style="margin-left: 12px; color:#0d6efd; font-size:20px">View Employee</a></span></li>
          ...
          <tbody>
            <?php foreach ($data as $row) : ?>
              <tr>
                ...
                <td><a href="viewEmployee.php?emp_id=<?php echo $row['emp_id']; ?>"><input type="button" value="View" class="btn btn-outline-primary b" style="width: 75px;"></a></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
