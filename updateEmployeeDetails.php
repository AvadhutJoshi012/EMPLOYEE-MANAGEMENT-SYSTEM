...
<?php session_start(); $_SESSION['updateEmp'] = false;  ?>
...
if (isset($_POST['update'])) {
  ...
  $insertquery = "UPDATE `employee` set `fullname` = '$fullname', `dob` = '$dob', `joining_date` = '$joining_date', `salary` = '$salary', `gender` =  '$gender', `email_id` = '$email_id', `contact_no` = '$contact_no', `aadhaar_no` = '$aadhaar_no', `pan_no` = '$pan_no', `address` = '$address', `zip_code` = '$zip_code', `city` = '$city', `state` = '$state', `experience` = '$experience', `company_name` = '$company_name', `refer_person` = '$refer_person', `refer_relation` = '$refer_relation', `refer_contact` = '$refer_contact', `designation` = '$designation', `shift` = '$shift', `shift_start` = '$shift_start', `shift_end` = '$shift_end' where `emp_id` = $idnew";
...
?>
  ...
  ?>
    <script>
      alert('Employee Data Not Updated...')
    </script>
<?php
  }
}
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="main" style="overflow-y: auto ; max-height:92vh;">
      ...
      <form name="form" id="form" action="updateEmployeeDetails.php?id_new=<?php echo $emp_id; ?>" method="POST">
        ...
        <div class="row">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Full Name" name="fullname" id="fullname" autocomplete="off" required value="<?php echo $row['fullname'] ?> ">
        ...
        <div class="row">
                    <div class="col">
                        ...
                        <input placeholder="Enter Date of Birth" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="dob" name="dob" value="<?php echo $row['joining_date'] ?> " required>
                    ...
                    <div class="col">
                        ...
                        <input placeholder="Enter Joining Date" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="joining_date" name="joining_date" value="<?php echo $row['dob'] ?> " required>
        ...
        <div class="row">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Salary" name="salary" id="salary" autocomplete="off" required value="<?php echo $row['salary'] ?> ">
        ...
        <div class="row">
          <div class="col">
            <input type="email" class="form-control" placeholder="Enter Email ID" name="email_id" id="email_id" autocomplete="off" required value="<?php echo $row['email_id'] ?> ">
          ...
          <div class="col">
            <input type="tel" class="form-control" placeholder="Contact Number" name="contact_no" id="contact_no" autocomplete="off" required value="<?php echo $row['contact_no'] ?> ">
        ...
        <div class="row">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter Aadhaar Number" name="aadhaar_no" id="aadhaar_no" autocomplete="off" required value="<?php echo $row['aadhaar_no'] ?> ">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter PAN Card Number (OPTIONAL)" name="pan_no" id="pan_no" autocomplete="off" value="<?php echo $row['pan_no'] ?> ">
        ...
        <div class=" row">
          ...
          <hr width="100%" size="4">
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter Address" name="address" id="address" autocomplete="off" required value="<?php echo $row['address'] ?> ">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter ZIP Code" name="zip_code" id="zip_code" autocomplete="off" required value="<?php echo $row['zip_code'] ?> ">
        ...
        <div class="row">
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter City" name="city" id="city" autocomplete="off" required value="<?php echo $row['city'] ?> ">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter State" name="state" id="state" autocomplete="off" required value="<?php echo $row['state'] ?> ">
        ...
        <div class="row">
          ...
          <hr width="100%" size="4">
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter Experience" name="experience" id="experience" autocomplete="off" required value="<?php echo $row['experience'] ?> ">
          ...
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter Company Name" name="company_name" id="company_name" autocomplete="off" required value="<?php echo $row['company_name'] ?> ">
        ...
        <div class=" row">
          ...
          <hr width="100%" size="4">
          <div class="col">
            <input type="text" class="form-control" placeholder="Reference Person" name="refer_person" id="refer_person" autocomplete="off" required value="<?php echo $row['refer_person'] ?> ">
        ...
        <div class="row">
          <div class="col">
            <input type="text" class="form-control" placeholder="Reference Relation" name="refer_relation" id="refer_relation" autocomplete="off" required value="<?php echo $row['refer_relation'] ?> ">
          ...
          <div class="col">
            <input type="tel" class="form-control" placeholder="Reference Contact Number" name="refer_contact" id="refer_contact" autocomplete="off" required value="<?php echo $row['refer_contact'] ?> ">
        ...
        <div class="row">
          ...
          <hr width="100%" size="4">
          <div class="col">
            <input type="text" class="form-control" placeholder="Enter Designation" id="designation" name="designation" autocomplete="off" value="<?php echo $row['designation'] ?> ">
        ...
        <div class="row">
          <div class="col">
            ...
            <input placeholder="Shift Start Time" class="form-control" type="text" onfocus="(this.type='time')" onblur="(this.type='text')" id="shift_start" name="shift_start" value="<?php echo $row['shift_start'] ?> ">
          ...
          <div class="col">
            ...
            <input placeholder="Shift End Time" class="form-control" type="text" onfocus="(this.type='time')" onblur="(this.type='text')" id="shift_end" name="shift_end" value="<?php echo $row['shift_end'] ?> ">
        ...
        <center>
          <div class="row">
            ...
            <div class="col">
              <input type="submit" class="btn btn-primary" id="submitButton" name="update" value="Update" style="width: 75px"  onclick="return confirm('Are you sure you want to update this employee?')">
            </div>

            <div class="col">
              <a href="updateEmployee.php"><input type="button" class="btn btn-danger" id="" value="Cancel" style="width: 75px"></a>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('joining_date').addEventListener('input', function() {
                ...
                if (joining_date === '') {
                    ...
                    if (!joining_dateRegex.test(joining_date)) {
                        joining_dateError.style.display = 'inline'; // Show error message
                    } else {
